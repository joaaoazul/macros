...
const RAW: RawRecipe[] = [
  ...
  // ── Lote 4 (2026-07-22): cozinha internacional adaptada ─────────
  { id: 'frango-tikka-masala-light', name: 'Frango tikka masala light', emoji: '🍛', tags: ['jantar', 'internacional', 'proteico'], servings: 2, minutes: 35,
    ings: [['frango-peito', 300], ['iogurte-natural', 100], ['tomate', 200], ['cebola', 80], ['arroz-cozido', 300], ['azeite', 10]] },
  { id: 'pad-thai-camarao-light', name: 'Pad thai de camarão light', emoji: '🍜', tags: ['jantar', 'internacional', 'peixe'], servings: 1, minutes: 25,
    ings: [['massa-cozida', 170], ['camarao', 120], ['ovo', 55], ['cenoura', 50], ['manteiga-amendoim', 12], ['molho-soja', 12]] },
  { id: 'burrito-bowl-frango', name: 'Burrito bowl de frango', emoji: '🥣', tags: ['almoço', 'internacional', 'proteico', 'marmita'], servings: 1, minutes: 20,
    ings: [['frango-peito', 130], ['arroz-cozido', 150], ['feijao-preto', 100], ['milho-cozido', 50], ['abacate', 40], ['tomate', 60]] },
  { id: 'quesadilla-frango-queijo', name: 'Quesadilla de frango e queijo', emoji: '🫓', tags: ['jantar', 'internacional', 'rápido'], servings: 1, minutes: 12,
    ings: [['wrap', 60], ['frango-peito', 100], ['queijo-mozzarella', 45], ['pimento', 40]] },
  { id: 'salteado-vaca-brocolos-asiatico', name: 'Salteado asiático de vaca e brócolos', emoji: '🥢', tags: ['jantar', 'internacional', 'proteico'], servings: 1, minutes: 18,
    ings: [['vaca-magra', 140], ['brocolos', 150], ['molho-soja', 15], ['arroz-cozido', 160], ['alho', 6]] },
  { id: 'gyros-frango-iogurte', name: 'Gyros de frango com molho de iogurte', emoji: '🥙', tags: ['jantar', 'internacional'], servings: 1, minutes: 20,
    ings: [['wrap', 60], ['frango-peito', 130], ['iogurte-grego', 60], ['tomate', 60], ['cebola', 30], ['alface', 30]] },
  { id: 'chana-masala', name: 'Chana masala (caril de grão)', emoji: '🍛', tags: ['jantar', 'internacional', 'vegan', 'proteico'], servings: 2, minutes: 30,
    ings: [['grao', 350], ['tomate', 200], ['cebola', 100], ['arroz-cozido', 250], ['azeite', 12]] },
  { id: 'teriyaki-salmao', name: 'Salmão teriyaki com arroz', emoji: '🍱', tags: ['jantar', 'internacional', 'peixe'], servings: 1, minutes: 20,
    ings: [['salmao', 140], ['arroz-cozido', 170], ['molho-soja', 15], ['mel', 8], ['brocolos', 100]] },
  { id: 'shakshuka', name: 'Shakshuka (ovos em molho de tomate)', emoji: '🍳', tags: ['pequeno-almoço', 'internacional', 'vegetariano', 'proteico'], servings: 2, minutes: 25,
    ings: [['ovo', 220], ['tomate', 300], ['pimento', 100], ['cebola', 80], ['azeite', 12], ['pao-trigo', 80]] },
  { id: 'falafel-bowl', name: 'Bowl de falafel com hummus', emoji: '🧆', tags: ['almoço', 'internacional', 'vegan'], servings: 1, minutes: 20,
    ings: [{ name: 'Falafel', emoji: '🧆', per100: [333, 13, 32, 18], grams: 100 }, { name: 'Hummus', emoji: '🫓', per100: [177, 8, 20, 8], grams: 50 }, ['cuscuz', 120], ['tomate', 80], ['alface', 40]] },
  { id: 'poke-atum', name: 'Poke de atum', emoji: '🍣', tags: ['almoço', 'internacional', 'peixe', 'proteico'], servings: 1, minutes: 12,
    ings: [['atum-agua', 120], ['arroz-cozido', 160], ['abacate', 50], ['cenoura', 40], ['molho-soja', 12], ['milho-cozido', 40]] },
  { id: 'frango-limao-grego', name: 'Frango à grega com limão e batata', emoji: '🍋', tags: ['jantar', 'internacional'], servings: 2, minutes: 50,
    ings: [['frango-coxa', 300], ['batata', 350], ['azeite', 15], ['alho', 8]] },
  { id: 'ramen-rapido-ovo', name: 'Ramen rápido com ovo', emoji: '🍜', tags: ['jantar', 'internacional', 'rápido'], servings: 1, minutes: 15,
    ings: [['massa-cozida', 180], ['ovo', 110], ['cogumelos', 60], ['molho-soja', 15], ['cebola', 30]] },
  { id: 'strogonoff-brasileiro-light', name: 'Strogonoff brasileiro light', emoji: '🍲', tags: ['jantar', 'internacional'], servings: 2, minutes: 30,
    ings: [['frango-peito', 300], ['tomate', 120], { name: 'Natas light', emoji: '🥛', unit: 'ml', per100: [160, 2.5, 4, 15], grams: 100 }, ['arroz-cozido', 300], ['cogumelos', 100]] },
  { id: 'couscous-marroquino-legumes', name: 'Cuscuz marroquino com legumes', emoji: '🥘', tags: ['almoço', 'internacional', 'vegan', 'marmita'], servings: 2, minutes: 25,
    ings: [['cuscuz', 250], ['grao', 150], ['cenoura', 100], ['abobrinha', 120], ['cebola', 60], ['azeite', 15]] },
  { id: 'pita-atum-iogurte', name: 'Pita de atum com molho de iogurte', emoji: '🥙', tags: ['almoço', 'internacional', 'peixe', 'rápido'], servings: 1, minutes: 8,
    ings: [['pao-integral', 70], ['atum-agua', 100], ['iogurte-grego', 50], ['alface', 30], ['tomate', 50]] },
  { id: 'arroz-chau-chau-frango', name: 'Arroz chau-chau com frango', emoji: '🍚', tags: ['jantar', 'internacional'], servings: 1, minutes: 18,
    ings: [['arroz-cozido', 200], ['frango-peito', 110], ['ovo', 55], ['ervilhas', 60], ['cenoura', 40], ['molho-soja', 12]] },
  { id: 'chili-sin-carne', name: 'Chili sin carne', emoji: '🌶️', tags: ['jantar', 'internacional', 'vegan', 'proteico'], servings: 2, minutes: 30,
    ings: [['soja-texturizada', 70], ['feijao-preto', 250], ['tomate', 250], ['milho-cozido', 80], ['cebola', 80], ['arroz-cozido', 250]] },
  { id: 'frittata-legumes-queijo', name: 'Frittata de legumes e queijo', emoji: '🍳', tags: ['jantar', 'internacional', 'vegetariano', 'proteico'], servings: 2, minutes: 25,
    ings: [['ovo', 330], ['abobrinha', 120], ['pimento', 80], ['queijo-flamengo', 50], ['azeite', 10]] },
  { id: 'sopa-miso-tofu', name: 'Sopa rápida de tofu e cogumelos', emoji: '🍜', tags: ['sopa', 'internacional', 'vegan'], servings: 2, minutes: 15,
    ings: [['tofu', 150], ['cogumelos', 120], ['molho-soja', 15], ['cebola', 40]] },

  // ── Lote 4: clássicos portugueses adaptados ─────────────────────
  { id: 'arroz-pato-simplificado', name: 'Arroz de pato simplificado', emoji: '🦆', tags: ['jantar', 'tradicional'], servings: 4, minutes: 60,
    ings: [{ name: 'Pato assado desfiado', emoji: '🦆', per100: [201, 23, 0, 11], grams: 400 }, ['arroz-cozido', 600], ['cebola', 100], { name: 'Chouriço', emoji: '🌭', per100: [455, 24, 2, 38], grams: 40 }] },
  { id: 'jardineira-frango', name: 'Jardineira de frango', emoji: '🍲', tags: ['jantar', 'tradicional'], servings: 2, minutes: 40,
    ings: [['frango-peito', 280], ['batata', 300], ['cenoura', 120], ['ervilhas', 100], ['cebola', 80], ['azeite', 12]] },
  { id: 'massa-atum-portuguesa', name: 'Massada de atum', emoji: '🍝', tags: ['jantar', 'tradicional', 'peixe'], servings: 2, minutes: 25,
    ings: [['massa-cozida', 320], ['atum-agua', 200], ['tomate', 200], ['cebola', 80], ['azeite', 12]] },
  { id: 'rojoes-light', name: 'Rojões light no forno', emoji: '🍖', tags: ['jantar', 'tradicional'], servings: 2, minutes: 50,
    ings: [['porco-lombo', 320], ['batata', 300], ['alho', 10], ['azeite', 12]] },
  { id: 'acorda-ovo-light', name: 'Açorda de ovo light', emoji: '🍞', tags: ['jantar', 'tradicional'], servings: 2, minutes: 20,
    ings: [['pao-trigo', 160], ['ovo', 220], ['alho', 10], ['azeite', 15]] },
  { id: 'esparregado-ovo', name: 'Esparregado com ovo escalfado', emoji: '🥬', tags: ['jantar', 'tradicional', 'vegetariano'], servings: 1, minutes: 20,
    ings: [['espinafres', 200], ['ovo', 110], ['leite-mg', 60], ['azeite', 8]] },
  { id: 'meia-desfeita-bacalhau', name: 'Meia-desfeita de bacalhau e grão', emoji: '🐟', tags: ['almoço', 'tradicional', 'peixe'], servings: 2, minutes: 30,
    ings: [['bacalhau', 250], ['grao', 250], ['ovo', 110], ['cebola', 80], ['azeite', 15]] },
  { id: 'peru-estufado-ervilhas', name: 'Peru estufado com ervilhas', emoji: '🦃', tags: ['jantar', 'tradicional', 'proteico'], servings: 2, minutes: 35,
    ings: [['peru-peito', 300], ['ervilhas', 200], ['cenoura', 100], ['cebola', 80], ['azeite', 12]] },
  { id: 'salada-polvo', name: 'Salada de polvo', emoji: '🐙', tags: ['almoço', 'salada', 'tradicional', 'peixe'], servings: 2, minutes: 15,
    ings: [['polvo', 250], ['cebola', 60], ['pimento', 60], ['azeite', 15]] },
  { id: 'pica-pau-light', name: 'Pica-pau light', emoji: '🥩', tags: ['jantar', 'tradicional'], servings: 2, minutes: 20,
    ings: [['vaca-magra', 300], ['alho', 10], ['azeite', 12], ['pao-trigo', 100]] },

  // ── Lote 4: mais rápidos e low-cal ──────────────────────────────
  { id: 'omelete-atum', name: 'Omelete de atum', emoji: '🍳', tags: ['jantar', 'proteico', 'rápido'], servings: 1, minutes: 10,
    ings: [['ovo', 110], ['atum-agua', 80], ['cebola', 30], ['azeite', 5]] },
  { id: 'frango-abacaxi-grelhado', name: 'Frango grelhado com ananás', emoji: '🍍', tags: ['jantar', 'proteico', 'rápido'], servings: 1, minutes: 15,
    ings: [['frango-peito', 150], ['ananas', 120], ['arroz-cozido', 140]] },
  { id: 'tosta-frango-desfiado', name: 'Tosta de frango desfiado', emoji: '🥪', tags: ['almoço', 'snack', 'proteico', 'rápido'], servings: 1, minutes: 8,
    ings: [['pao-integral', 60], ['frango-peito', 90], ['iogurte-grego', 30], ['alface', 20]] },
  { id: 'wrap-salmao-fumado', name: 'Wrap de salmão fumado', emoji: '🌯', tags: ['almoço', 'peixe', 'rápido'], servings: 1, minutes: 6,
    ings: [['wrap', 60], { name: 'Salmão fumado', emoji: '🐟', per100: [117, 18, 0, 4.5], grams: 60 }, ['queijo-fresco', 40], ['alface', 30]] },
  { id: 'salada-cottage-pessego', name: 'Salada de cottage e pêssego', emoji: '🍑', tags: ['snack', 'salada', 'vegetariano', 'proteico', 'rápido'], servings: 1, minutes: 5,
    ings: [['queijo-cottage', 150], ['pessego', 120], ['nozes', 10]] },
  { id: 'iogurte-proteico-granola', name: 'Iogurte proteico com granola e mel', emoji: '🥛', tags: ['snack', 'proteico', 'rápido'], servings: 1, minutes: 3,
    ings: [['iogurte-proteico', 200], ['granola', 25], ['mel', 8]] },
  { id: 'batido-kiwi-espinafres', name: 'Batido verde de kiwi e espinafres', emoji: '🥝', tags: ['snack', 'batido', 'vegan', 'rápido'], servings: 1, minutes: 4,
    ings: [['kiwi', 150], ['espinafres', 40], ['banana', 80], ['leite-aveia', 200]] },
  { id: 'clementinas-amendoas', name: 'Clementinas com amêndoas', emoji: '🍊', tags: ['snack', 'vegan', 'rápido'], servings: 1, minutes: 2,
    ings: [['clementina', 150], ['amendoas', 20]] },
]
